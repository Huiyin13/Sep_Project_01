	...
	<div class="container customer-register">
		<div class="row">
			<div class="col-sm-8 col-sm-offset-8">
				<h2><b>Ban User</b></h2>
                @foreach($data as $row)
				<form action="{{ route('ManageAccount.banR', $row->Rider_ID) }}" method="post">
				@csrf
                @method('PUT')
				<table>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td><button type="button" onclick="location.href='{{ route('ManageAccount.viewProfileR', $row->Rider_ID) }}'" style="background-color: red; border: none; color: white; padding: 5px 10px">CANCEL</button></td>
                        </tr>
                    @endforeach
				</table>
