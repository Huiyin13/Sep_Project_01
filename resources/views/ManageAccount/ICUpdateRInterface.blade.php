            ...
            @foreach($data as $row)
				...
				<table>
					...
					<tr>
						...
						<td></td>
						<td><button type="button" style="background-color: red; border: none; color: white; padding: 5px 10px" onclick="location.href='{{ route('ManageAccount.viewProfileR', $row->Rider_ID) }}'">CANCEL</button></td>
					</tr>
